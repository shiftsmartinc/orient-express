...
@overload
def get_predictor(
    dir: str, device: str = Device.CPU, *, expected_type: type[T], **kwargs: Any
) -> T: ...


@overload
def get_predictor(dir: str, device: str = Device.CPU, **kwargs: Any) -> Any: ...
...
def get_predictor(
    ...
    **kwargs: Any,
    ...
    from_dir (e.g. provider_options); joblib artifacts
    accept none.
    """
